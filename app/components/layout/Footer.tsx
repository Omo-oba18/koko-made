...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-[var(--color-onyx)] text-[var(--color-ivory)]"
      role="contentinfo"
    >
      {/* ── Main grid ─────────────────────────────────────────────── */}
      <div className="container-luxury">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 pt-28 pb-20">
          {/* Brand block */}
          <div className="md:col-span-5 flex flex-col gap-8">
            ...
            <div className="flex items-center gap-5">
              {(Object.entries(STYLIST.social) as [string, string][]).map(
                ([platform, url]) => (
                  <a
                    key={platform}
                    href={url}
                  ...
                  >
                    {SOCIAL_ICONS[platform] ?? (
                      <span className="label-tag-light capitalize text-[0.55rem]">
                        {platform.slice(0, 2)}
                      </span>
                    )}
                  </a>
      ...
      >
        <div className="container-luxury py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
            <span className="label-tag-light">Cotonou &amp; Bénin</span>
            ...
            <span className="label-tag-light">Koko Made</span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-body text-xs font-light transition-all duration-300 hover:text-[var(--color-gold)]"
              style={{
                color: "rgba(255,255,255,0.45)",
              }}
            >
              Développé & designé par <strong>Chablis Mahutin</strong>
            </a>
          </div>
        </div>
      </div>
